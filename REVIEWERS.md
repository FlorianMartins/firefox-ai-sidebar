...
- The submitted package corresponds to the git tag matching its `version`
  (e.g. version `1.27.0` → tag `v1.27.0`).
...
git checkout v1.27.0            # use the tag matching the submitted version
...
- `ai-sidebar-1.27.0-firefox.zip`  (Firefox — built from `manifest.json`)
- `ai-sidebar-chrome-1.27.0.zip`   (Chromium — built from `manifest.chrome.json`)
