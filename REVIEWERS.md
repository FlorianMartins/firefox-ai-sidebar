...
- The submitted package corresponds to the git tag matching its `version`
  (e.g. version `1.22.5` → tag `v1.22.5`).
...
git checkout v1.22.5            # use the tag matching the submitted version
...
- `ai-sidebar-1.22.5-firefox.zip`  (Firefox — built from `manifest.json`)
- `ai-sidebar-chrome-1.22.5.zip`   (Chromium — built from `manifest.chrome.json`)
