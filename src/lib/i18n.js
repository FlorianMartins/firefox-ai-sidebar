...
const EN = {
  ...
  "pick.restricted": "This kind of browser page can't be captured — switch to a website tab and try again.",
...
const FR = {
  ...
  "pick.restricted": "Ce type de page du navigateur ne peut pas être capturé — passez sur un onglet de site web et réessayez.",
